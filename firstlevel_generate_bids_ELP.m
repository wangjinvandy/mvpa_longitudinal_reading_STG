...
addpath(genpath('/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/mvpa_PhonReading_5_7/scripts')); % the path of your scripts
spm_path='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/LabCode/typical_data_analysis/spm12_elp'; %the path of spm
addpath(genpath(spm_path));

%define your data path
data=struct();
root='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/mvpa_PhonReading_5_7';  %your project path
subjects=[];
...
analysis_folder='analysis_ses5_s6'; % the name of your first level modeling folder
...
CCN.file='vw*sub*bold.nii'; % the name of your preprocessed data (4d)
...
%matched.
contrasts={'allwords_vs_perc' 'onset_vs_perc_run1' 'onset_vs_perc_run2' ...
 	'rhyme_vs_perc_run1' 'rhyme_vs_perc_run2' ...
	'unrelated_vs_perc_run1' 'unrelated_vs_perc_run2'};

allwords_vs_perc=[-3 1 1 1];
onset_vs_perc=[-1 1 0 0];
rhyme_vs_perc=[-1 0 1 0];
unrelated_vs_perc=[-1 0 0 1];

%adjust the contrast by adding six 0s into the end of each session
rp_w=zeros(1,6);
empty=zeros(1,10);
weights={[allwords_vs_perc, rp_w, allwords_vs_perc, rp_w]...
[onset_vs_perc, rp_w, empty]...
[empty, onset_vs_perc, rp_w]...
[rhyme_vs_perc, rp_w, empty]...
[empty, rhyme_vs_perc, rp_w]...
[unrelated_vs_perc, rp_w, empty]...
[empty, unrelated_vs_perc, rp_w]};
