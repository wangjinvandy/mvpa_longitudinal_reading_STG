...
%%This code is a re-preprocess of the Longitudinal_Reading_vOT dataset after its full preprocessing. https://github.com/wangjinvandy/Longitudinal_Reading_vOT

global CCN;
addpath(genpath('/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/mvpa_PhonReading_5_7/scripts')); %This is the code path
spm_path='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/LabCode/typical_data_analysis/spm12_elp'; %This is your spm path
addpath(genpath(spm_path));
root='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/mvpa_PhonReading_5_7'; %This is your project folder
subjects={};
data_info='/gpfs51/dors2/gpc/JamesBooth/JBooth-Lab/BDL/jinwang/mvpa_PhonReading_5_7/scripts/participants.xlsx'; %final_sample sheet
if isempty(subjects)
...
try
    ...
    for i=1:length(subjects)
        ...
        for m=1:length(func_f)
            ...
            rp_file{m}=expand_path([func_f{m} '[rp_pattern]']);
        end
        ...
        for ii=1:length(func_files)
            [swfunc_p,swfunc_n,swfunc_e] = fileparts(char(func_files{ii}));
